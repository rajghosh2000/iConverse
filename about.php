        ...
        <div class="container mx-auto flex px-5 py-16 md:flex-row flex-col items-center">
            ...
            <div class="xl:w-1/3 md:w-1/2 p-4">
                <div class="border border-gray-800 p-6 rounded-lg">
                    ...
                    <p class="leading-relaxed text-base"><a
                            href="https://www.facebook.com/profile.php?id=100027649521893" target="_blank">Rajdeep
                            Ghosh</a></p>
                </div>
            </div>
            <div class="xl:w-1/3 md:w-1/2 p-4">
            ...
            <div class="xl:w-1/3 md:w-1/2 p-4">
                <div class="border border-gray-800 p-6 rounded-lg">
                    ...
                    <p class="leading-relaxed text-base"><a href="https://www.instagram.com/i_m_the_rajdeep/"
                            target="_blank">i_m_the_rajdeep</a></p>
                </div>
            </div>
        </div>
    </section>
